...
class VG(AbstractVQA):
    ...
    def __init__(self,
        ...
        # print("-"*20)
        # question = self.dataset['questions'][0]['question']
        # print("="*20)
        # print(question)
        # print(k)
    ...
    def load_obj_vocab(self):
        ...
        # path = '/home/abr/Data/MuHiPAFramework/MuHiPA/datasets/block/datasets/'
    ...
    def __getitem__(self, index):
        ...
        if self.load_original_annotation:
            item['original_question'] = question['question']
